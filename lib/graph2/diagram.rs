...
use crate::graph2::{ GraphError, GraphResult, NodeId, QubitId, ZX, ZH, CT };
use GraphError::*;
...
///
/// See [`zx`][crate::graph2::zx] for more information.
pub type DiagramZX = Diagram<ZX>;

/// A diagram in the ZH-calculus.
///
/// See [`zh`][crate::graph2::zh] for more information.
pub type DiagramZH = Diagram<ZH>;

/// A diagram in the Clifford+*T*-restricted ZX-calculus.
///
/// See [`clifft`][crate::graph2::clifft] for more information.
