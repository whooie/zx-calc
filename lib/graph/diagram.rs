...
impl Diagram {
    ...
    // elements
    fn element_explore<'a, A>(
        &'a self,
        wire_nums: &WireStore,
        visited: &mut Vec<NodeId>,
        to_visit: &mut VecDeque<(NodeId, &'a Node)>,
        elements: &mut Vec<crate::tensor::Element<A>>,
    )
    where A: crate::tensor::ElementData
    {
        ...
        if !empty_wires.is_empty() {
            ...
            let mut swaps: Vec<tensor::Element<A>> = Vec::new();
    ...
    /// representation.
    pub fn to_tensor<A>(&self) -> crate::tensor::Diagram<A>
    where A: crate::tensor::ElementData
    {
        use crate::tensor as tensor;
        ...
        // tensor accumulator
        let mut elements: Vec<tensor::Element<A>> = Vec::new();
